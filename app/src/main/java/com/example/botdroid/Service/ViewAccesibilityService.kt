...
class ViewAccesibilityService : AccessibilityService() {
        ...
        scanRunnable = object : Runnable {
            override fun run() {
                ...
                if (rootNode != null) {
                    ...
                    clickButtonByContentDescription(rootNode, "Dar me gusta a un video")
                }
    ...
    private fun recorrerNodo(node: AccessibilityNodeInfo?, depth: Int) {
        ...
        Log.d("Accesibilidad", "$indent- Clase: $className | Texto: $text | ID: $viewId | Descripción: $contentDescription | Clickable: $isClickable | Visible: $isVisible | Enabled: $isEnabled | isEditable $isEditable | ss $ss")
